...
package GL.Binding is
   ...
   procedure rodTexImage2D
     (target         : in GLenum;
      ...
      pixels         : in interfaces.c.strings.chars_ptr);
		--GLvoid_Pointer); --same as system.address
   ...
   procedure glTexImage2D
     (target         : in GLenum;
      ...
      format         : in GLenum;
      the_type       : in GLenum;
      pixels         : in GLvoid_Pointer); --same as system.address
   ...
   procedure glGenTextures
     (n        : in GLsizei;
      textures : in system.address); --GLuint_Pointer);
...
private
   ...
   pragma Import (StdCall, rodglGetBooleanv, "glGetBooleanv");
   ...
   pragma Import (StdCall, rodTexImage2D, "glTexImage2D");
